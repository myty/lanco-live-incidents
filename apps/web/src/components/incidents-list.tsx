...
export default function IncidentsList({ loading = false, incidents }: IncidentsListProps) {
  ...
  if (emptyList) {
    return (
      <div className="flex items-center justify-center text-xl font-light text-gray-400 h-96">No incidents found</div>
    );
  }
